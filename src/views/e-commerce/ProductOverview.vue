            ...
            <div class="col-12 lg:col-7">
                <div class="flex">
                    ...
                    <div class="pl-3 w-10 flex">
                        <img :alt="images[selectedImageIndex]" :src="contextPath + `demo/images/ecommerce/productoverview/${images[selectedImageIndex]}`" class="w-full border-2 border-transparent border-round" />
                    </div>
                </div>
            </div>
